    ...
    @if ($product->shopper_link != "" && $chap->number_order != 1 && $_SESSION['show_url_shopee'] == 'y')
        <div class="container">
            <div class="contentShopee">
                ...
                <p><i class="fa-solid fa-hand-point-right"></i> <a onclick="unlockPage();" rel="noopener noreferrer" target="_blank" href="{{$product->shopper_link}}">{{$product->shopper_link}}</a></p>
                <div class="imgShopee">
