<div>
    ...
    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">CHỈNH SỬA Truyện</h3>
    ...
    <form class="p-4 md:p-5" wire:submit.prevent="storeOrderProduct" onsubmit="return false">
        <div class="grid gap-4 mb-4 grid-cols-2">
            <div class="col-span-2">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Truyện</label>
                <div class="mt-2">
